...
onready var water_spring = preload("res://addons/water2d2/Scenes/Water_Spring.tscn")
...
onready var splash_particle = preload("res://addons/water2d2/Scenes/splash_particles.tscn")
